...
class BasicWindow(QtWidgets.QMainWindow):
    ...
    def initializeParams(self):
        ...
        self.old_data = False            # stores plotted data for checking if it changed after user-action.
    ...
    def setGridLayout(self):
        ...
        self.func_combo = QtWidgets.QComboBox(self.centralWidget)
        self.func_combo.clear()
        self.func_combo.setDisabled(True)
        self.func_combo.activated.connect(self.funcComboChange)
        self.func_combo.addItems(self.postfunc.keys())
        self.func_combo.setCurrentText("----")
        self.func_combo.setObjectName("math-Combo")
        ...
        self.dimensionCombo.activated.connect(self.plot_dimension_change)
        ...
        dataParamsLayout.addWidget(self.func_combo, 0, 5)
    ...
    def initialLoad(self):
        ...
        if self.file_type == "cobold" or self.file_type == "mean":
        ...
        if self.file_type == "cobold" or self.file_type == "nicole":
        ...
        self.func_combo.setDisabled(False)
    ...
    def setQuantity(self, mod, dat, tau=None):
        # TODO: new class for computing quantities
        self.senders.append(self.sender().objectName())
        ...
        return ne.evaluate(self.postfunc[self.func_combo.currentText()], local_dict={'data': data})
