...
def main():
    ...
    splash.showMessage("Load Model and ProfileReader from nicole", Qt.Qt.AlignCenter | Qt.Qt.AlignBottom)
    ...
    splash.showMessage("Load main window", Qt.Qt.AlignCenter | Qt.Qt.AlignBottom)
